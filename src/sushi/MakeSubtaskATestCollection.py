...
if __name__ == '__main__':
    ...
    queryTables = readQueries('../../resources/sushi/titlequeries.xlsx')
    officialTopicTables = readOfficialTopics('../../resources/sushi/SushiSubtaskADevTopicsNov29.xlsx')
    if condition =='Dry Run':
        ...
        writeQrels('/Users/shashank/Research/sushi/Ntcir18SushiDryRunFolderQrelsV1.1.tsv', '/Users/shashank/Research/sushi/Ntcir18SushiDryRunBoxQrelsV1.1.tsv', topicSets)
        print('Subtask A Dry Run Test Collection and Qrels Built')
    elif condition == 'Official':
        topicSets, trainingSets = setupEcf(officialTopicTables, fullCollection, setSize=5, maxSets=2,condition=condition)
        print(f'topicSets: {topicSets}')
        topicSets = writeEcf('/Users/shashank/Research/sushi/NtcirSushiOfficialExperimentControlFileV1.0.json', 'Debugging Version of Official ECF with 10 Topics', trainingSets, topicSets,
                             'T18Eval', 1)
        ...
        topicSets = writeEcf(prefix + 'ecftest.json', 'Dry Run-Like Test Set of Selected Size', trainingSets, topicSets, 'TEST', 1)
        topicSets = setupQrels(queryTables, topicSets)
